namespace MetierRvMedical2.Migrations
{
    using System;
    using System.Data.Entity;
    using System.Data.Entity.Migrations;
    using System.Linq;
    using MetierRvMedical2.config;
    using MetierRvMedical2.Models;

    internal sealed class Configuration : DbMigrationsConfiguration<MetierRvMedical2.Models.bdRdvMedicalContext>
    {
        ...
        protected override void Seed(MetierRvMedical2.Models.bdRdvMedicalContext context)
        {
            ...
            //{
            //    if (!context.Secretaires.Any(s => s.Identifiant == secretaire.Identifiant))
            //    {
            //        context.Secretaires.Add(secretaire);
            //    }
            //}

            //FactorySeed.SeedMedecinsAndAgendas(5, context);

            //            var patients = FactorySeed.GetPatients(10); 
            //foreach (var patient in patients)
            //{
            //    if (!context.Patients.Any(p => p.Email == patient.Email))
            //    {
